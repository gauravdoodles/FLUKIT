...
class HomeVisualInspiration extends StatelessWidget {
  HomeVisualInspiration({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 1670.0, 900.0),
                    size: Size(1670.0, 900.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child:
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(663.0, 60.0, 1007.0, 840.0),
                          size: Size(1670.0, 900.0),
                          pinRight: true,
                          pinTop: true,
                          pinBottom: true,
