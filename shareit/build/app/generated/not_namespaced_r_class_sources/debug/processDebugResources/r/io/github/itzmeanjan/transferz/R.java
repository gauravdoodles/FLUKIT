...
public final class R {
  ...
  public static final class color {
    ...
    public static final int launchBackground=0x7f020001;
    ...
    public static final int secondary_text_default_material_light=0x7f020005;
  }
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha io.github.itzmeanjan.transferz:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name io.github.itzmeanjan.transferz:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority io.github.itzmeanjan.transferz:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts io.github.itzmeanjan.transferz:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy io.github.itzmeanjan.transferz:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout io.github.itzmeanjan.transferz:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage io.github.itzmeanjan.transferz:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery io.github.itzmeanjan.transferz:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name io.github.itzmeanjan.transferz:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name io.github.itzmeanjan.transferz:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name io.github.itzmeanjan.transferz:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name io.github.itzmeanjan.transferz:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name io.github.itzmeanjan.transferz:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name io.github.itzmeanjan.transferz:fontProviderQuery
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font io.github.itzmeanjan.transferz:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle io.github.itzmeanjan.transferz:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings io.github.itzmeanjan.transferz:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight io.github.itzmeanjan.transferz:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex io.github.itzmeanjan.transferz:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name io.github.itzmeanjan.transferz:font
     */
     ...
     * </table>
     *
     * @attr name io.github.itzmeanjan.transferz:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name io.github.itzmeanjan.transferz:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name io.github.itzmeanjan.transferz:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name io.github.itzmeanjan.transferz:ttcIndex
     */
